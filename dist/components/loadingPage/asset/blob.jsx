...
function Blob({ theme, isLoading }) {
    return (<div className={Loading_style_module_css_1.default.svgContainer} style={{ backgroundColor: theme === 'dark' ? '#021722' : '#083c56' }}>
      <svg id='visual' viewBox='-30 0 960 540' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' version='1.1'>
        <path className={Loading_style_module_css_1.default.blob} fill='#e2b783'>
          <animate attributeName='d' dur='7s' repeatCount='indefinite' values='M129 -65.6C161.1 -19 176.7 46 152.4 94.8C128.2 143.7 64.1 176.3 -6.9 180.3C-77.9 184.3 -155.9 159.7 -180.1 110.8C-204.4 62 -174.9 -11 -136 -61.6C-97 -112.3 -48.5 -140.5 0 -140.5C48.5 -140.5 97 -112.3 129 -65.6;
